      ...
      return (
        <div key={blockIdx} className="space-y-4 pt-5 border-t border-slate-100 first:pt-0 first:border-0">
          <h2 className="font-heading text-xl sm:text-2xl font-extrabold text-slate-950 tracking-tight flex items-center gap-3">
            <span className="w-2 h-6 rounded-full bg-[#EA580C] shrink-0" />
            <span>{headingText}</span>
          </h2>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2 mb-1.5">
                    <span className="px-2.5 py-0.5 rounded-lg bg-sky-100 text-[#0284C7] font-mono text-[11px] font-bold uppercase tracking-wider group-hover:bg-[#0284C7] group-hover:text-white transition-colors">
                      {key}
                    </span>
                  </div>
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12 font-sans">
      ...
      <article className="bg-white p-6 sm:p-10 rounded-[28px] border border-slate-200/80 shadow-[0_4px_24px_rgba(0,0,0,0.02)] space-y-6 relative overflow-hidden">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-slate-100 pt-1">
          <div className="flex items-center gap-2">
            <span className="px-3 py-1 rounded-full bg-[#D8EEFD] text-[#0369A1] text-xs font-bold uppercase tracking-wider">
        ...
        <div className="pt-6 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-sky-100 to-amber-100 p-0.5 shadow-2xs flex items-center justify-center shrink-0">
          ...
          <Link
            href="/student/tests"
            className="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-full bg-black hover:bg-neutral-800 text-white font-medium text-xs shadow-xs transition-all hover:scale-[1.02] cursor-pointer"
          >
