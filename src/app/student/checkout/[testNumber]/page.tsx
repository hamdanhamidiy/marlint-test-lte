    ...
    <div className="max-w-5xl mx-auto space-y-6 font-sans pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="bg-white rounded-[26px] p-5 sm:p-6 border border-slate-200/90 shadow-[0_4px_24px_rgba(0,0,0,0.02)] space-y-5">
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2 py-0.5 rounded-md bg-[#EA580C] text-white text-[9px] font-black uppercase">
                        Instan
                      </span>
                    </div>
                    <p className="text-xs text-slate-500 mt-0.5">
              ...
              <div className="space-y-2">
                <p className="text-[11px] font-bold uppercase tracking-wider text-slate-400 px-1 pt-1">
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-bold text-xs sm:text-[13px] text-slate-800">{bank.name}</span>
                    </div>
                    ...
                    <div className={`w-4.5 h-4.5 rounded-full border-2 flex items-center justify-center shrink-0 ${
                      ...
                      {selectedMethod === bank.id && <Check className="w-2.5 h-2.5 text-white" />}
                    </div>
                  </div>
                ))}
              </div>

              {/* Option 3: E-Wallet Direct */}
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                        ...
                        {selectedMethod === ew.id && <Check className="w-2.5 h-2.5 text-white" />}
                      </div>
                    </div>
                  ))}
                </div>
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="bg-white rounded-[26px] p-5 sm:p-6 border border-slate-200/90 shadow-[0_4px_24px_rgba(0,0,0,0.02)] space-y-5 sticky top-20">
            <div>
              <h2 className="font-heading text-lg font-bold text-slate-900">
                Ringkasan Pesanan
              </h2>
              <p className="text-xs text-slate-500 mt-0.5">
                Konfirmasi item sertifikasi dan lisensi asesmen.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#F8FAFC] border border-slate-200/80 space-y-3">
              <div className="flex items-start justify-between gap-2">
                <div>
                  <span className="px-2.5 py-0.5 rounded-full bg-[#D8EEFD] text-[#0369A1] text-[10px] font-extrabold uppercase">
                    Paket #{testNumber}
                  </span>
              ...
              <div className="pt-2 border-t border-slate-200/60 flex items-center gap-2 text-[11px] text-emerald-700 font-semibold">
                ...
                <span>Termasuk Penerbitan Sertifikat Digital Resmi</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-3.5 px-6 rounded-full font-bold text-sm text-white bg-black hover:bg-neutral-800 transition-all flex items-center justify-center gap-2 cursor-pointer shadow-md hover:scale-[1.01] active:scale-98"
            >
