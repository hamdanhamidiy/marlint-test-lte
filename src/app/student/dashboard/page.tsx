      ...
      <div className="flex-1 w-full space-y-4 sm:space-y-5 min-w-0">
        ...
        <div className="relative overflow-hidden rounded-[26px] bg-gradient-to-r from-[#0284C7] via-[#0369A1] to-[#0B192C] p-5 sm:p-6 lg:p-7 text-white shadow-lg shadow-sky-500/15">
          ...
          <div className="relative z-10 space-y-3.5 sm:space-y-4">
            ...
            <div className="pt-1 flex flex-wrap items-center gap-2.5">
              <Link
                href="/student/tests"
                className="inline-flex items-center gap-1.5 px-4.5 py-2.5 rounded-xl bg-white hover:bg-slate-50 text-slate-950 text-xs font-bold transition-all duration-300 ease-out shadow-md hover:scale-[1.03] hover:shadow-lg hover:shadow-black/10 active:scale-[0.97]"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 px-4.5 py-2.5 rounded-xl bg-white/10 hover:bg-white/20 text-white border border-white/20 text-xs font-bold transition-all duration-300 ease-out backdrop-blur-xs hover:scale-[1.03] hover:border-white/40 active:scale-[0.97]"
              >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between gap-3">
            ...
            <Link
              href="/student/tests"
              className="inline-flex items-center gap-1 text-xs font-bold text-[#0284C7] hover:text-[#0369A1] transition-colors duration-200 shrink-0"
            >
              <span>Lihat Semua (10)</span>
              <ArrowRight className="w-3.5 h-3.5 transition-transform duration-200 hover:translate-x-0.5" />
            </Link>
          </div>
            ...
            {loading ? (
              ...
              tests.slice(0, 3).map((test) => {
                ...
                return (
                  <div
                    key={test.id}
                    className="bg-white rounded-2xl p-4 sm:p-4.5 border border-slate-200/80 hover:border-sky-400/90 shadow-xs hover:shadow-xl hover:shadow-sky-500/10 hover:-translate-y-1 transition-all duration-300 ease-out flex flex-col justify-between h-full group"
                  >
                    {/* Top Tag & Access Indicator */}
                    <div className="space-y-2">
                      <div className="flex items-center justify-between gap-2">
                        <span className={`px-2 py-0.5 rounded-md text-[10px] font-extrabold tracking-tight transition-colors duration-200 ${
                        ...
                        {hasAccess ? (
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-700 text-[10px] font-bold border border-emerald-200 shrink-0 transition-transform duration-200 group-hover:scale-105">
                            <Unlock className="w-3 h-3 text-emerald-600" />
                            <span>{test.is_free ? 'Gratis' : 'Akses Terbuka'}</span>
                          </span>
                        ) : (
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-amber-50 text-amber-800 text-[10px] font-bold border border-amber-200 shrink-0 transition-transform duration-200 group-hover:scale-105">
                      ...
                      <div className="space-y-1">
                        <h3 className="font-extrabold text-slate-950 text-sm leading-snug group-hover:text-[#0284C7] transition-colors duration-200 line-clamp-1">
                          {formattedTestName}
                        </h3>
                    ...
                    <div className="pt-2.5 mt-2.5 border-t border-slate-100 space-y-2.5">
                      ...
                      <Link
                        ...
                        className={`w-full flex items-center justify-center gap-1.5 py-2.5 px-3.5 rounded-xl text-xs font-bold transition-all duration-300 ease-out cursor-pointer shadow-md hover:scale-[1.02] active:scale-[0.98] ${
                          hasAccess
              ...
              <tbody className="divide-y divide-slate-100 text-xs">
                {recentResults.length > 0 ? (
                  recentResults.map((res) => (
                    <tr key={res.id || res.attempt_id} className="hover:bg-sky-50/60 transition-all duration-250 ease-out group">
                      <td className="py-3.5 pr-4">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-xl bg-sky-50 text-[#0284C7] border border-sky-100 flex items-center justify-center font-bold text-xs shrink-0 shadow-2xs group-hover:scale-105 transition-transform duration-250">
                            <FileCheck2 className="w-4 h-4" />
                          </div>
                          <div>
                            <p className="font-extrabold text-slate-900 leading-tight group-hover:text-[#0284C7] transition-colors duration-200">{res.test_name}</p>
                      ...
                      <td className="py-3.5 text-right">
                        <Link
                          ...
                          className="inline-flex items-center justify-center w-8 h-8 rounded-xl border border-slate-200 hover:border-[#0284C7] text-slate-400 hover:text-[#0284C7] hover:bg-sky-50 hover:scale-110 active:scale-95 transition-all duration-250 shadow-2xs"
                  ...
                  articles.map((art) => (
                    <tr key={art.id} className="hover:bg-sky-50/60 transition-all duration-250 ease-out group">
                      <td className="py-3.5 pr-4">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-xl bg-slate-100 text-slate-800 flex items-center justify-center font-bold text-xs shrink-0 shadow-2xs group-hover:scale-105 transition-transform duration-250">
                            <BookOpen className="w-4 h-4" />
                          </div>
                          <div>
                            <p className="font-extrabold text-slate-900 leading-tight group-hover:text-[#0284C7] transition-colors duration-200">{art.title}</p>
                      ...
                      <td className="py-3.5 text-right">
                        <Link
                          ...
                          className="inline-flex items-center justify-center w-8 h-8 rounded-xl border border-slate-200 hover:border-[#0284C7] text-slate-500 hover:text-[#0284C7] hover:bg-sky-50 hover:scale-110 active:scale-95 transition-all duration-250 shadow-2xs"
                          title="Baca Materi"
                        >
                  ...
                  defaultSampleRows.map((row) => (
                    <tr key={row.id} className="hover:bg-sky-50/60 transition-all duration-250 ease-out group">
                      <td className="py-3.5 pr-4">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-xl bg-sky-50 text-[#0284C7] border border-sky-100 flex items-center justify-center font-bold text-xs shrink-0 shadow-2xs group-hover:scale-105 transition-transform duration-250">
                            {row.score !== null ? <FileCheck2 className="w-4 h-4" /> : <BookOpen className="w-4 h-4" />}
                          </div>
                          <div>
                            <p className="font-extrabold text-slate-900 leading-tight group-hover:text-[#0284C7] transition-colors duration-200">{row.title}</p>
                      ...
                      <td className="py-3.5 pr-4">
                        <div className="flex items-center gap-2">
                          {row.score !== null && (
                            <span className="font-mono font-bold text-[#0284C7] text-xs">{row.score}%</span>
                          )}
                          <span
                            className={`px-2 py-0.5 rounded-md text-[9px] font-extrabold uppercase ${
                              row.isPassed
