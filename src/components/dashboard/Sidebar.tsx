    ...
    <aside className="w-full sm:w-64 bg-white flex flex-col justify-between p-5 border-r border-slate-100 select-none h-full overflow-y-auto shrink-0">
      ...
      <div className="space-y-1 pt-4 border-t border-slate-100/80">
        ...
        <Link
          href="/student/redeem"
          onClick={onCloseMobile}
          className="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl text-xs font-semibold text-slate-600 hover:text-[#4F46E5] hover:bg-slate-50 transition-colors"
        >
        ...
        <Link
          ...
          onClick={onCloseMobile}
          className="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl text-xs font-semibold text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-colors"
        >
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-2xl text-xs font-semibold text-[#FF6464] hover:bg-rose-50/70 transition-colors text-left cursor-pointer"
        >
